...
const LifeEvents = () => {
  ...
  const { name, birthday, anniversary } = singleRelationship
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.block}>
        <Text style={styles.h1}>{name}'S LIFE EVENTS</Text>
      </View>

      <View style={styles.body}>
        <Card>
          <Text style={styles.title}>Birthday</Text>
          <Text style={styles.next}>{birthday}</Text>
        </Card>

        <Card>
          <Text style={styles.title}>Anniversary</Text>
          <Text style={styles.next}>{anniversary}</Text>
        </Card>
      </View>
